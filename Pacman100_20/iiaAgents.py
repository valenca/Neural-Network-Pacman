...
class iiaPacmanAgent(Agent):
	...
	def convertState(self, state, stateRepresentation):
		...
		if direction == Directions.NORTH:
			...
			pos = [2,3,0,1,6,7,4,5,10,11,8,9,14,15,12,13,18,19,16,17]
		elif direction == Directions.EAST or direction == Directions.STOP:
			pos = [4,5,6,7,2,3,0,1,12,13,14,15,10,11,8,9,17,18,19,16]
		elif direction == Directions.WEST:
			pos = [6,7,4,5,0,1,2,3,14,15,12,13,8,9,10,11,19,16,17,18]
