...
class LearningKeyboardAgent(Agent):
  ...
  def getTrainingName(self):
	  ...
	  name = "training_"
	  count = 1
	  while os.path.isfile("training/human/" + layout.lName + "/" + iiaAgents.ghostN + "/" + name + str(count) + ".iia"):
		  count += 1
	  return "training/human/" + layout.lName + "/" + iiaAgents.ghostN + "/" + name + str(count) + ".iia"
